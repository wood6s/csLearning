...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    player_score, opponent_score = max(player_score, opponent_score), min(player_score, opponent_score)
    if opponent_score == 0:
        return False
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def announce(player0, player1):
        high = running_high
        if who == 0:
            diff = player0 - last_score
            if diff > high:
                print(diff, "point(s)! The most yet for Player 0")
                high = diff
            return announce_highest(who, player0, high)
        else:
            diff = player1 - last_score
            if diff > high:
                print(diff, "point(s)! The most yet for Player 1")
                high = diff
            return announce_highest(who, player1, high)
    return announce
    # END PROBLEM 7
